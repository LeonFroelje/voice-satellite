...
class Client:
    ...
    def process_segments(self, segments, translated=False):
        ...
        if self.log_transcription:
            if self.enable_timestamps:
                ...
                clear_screen()
                print_transcript(original_text_with_timestamps, timestamps=True)
                ...
                clear_screen()
                print_transcript(original_text)
    ...
    def write_srt_file(self, output_path="output.srt"):
        ...
        if self.enable_translation:
            create_srt_file(self.translated_transcript, self.translation_srt_file_path)
